...
#echo "添加 passwall"
#git clone -b packages https://github.com/xiaorouji/openwrt-passwall.git ./package/passwallpackages
#git clone -b luci https://github.com/xiaorouji/openwrt-passwall.git ./package/passwallluci
