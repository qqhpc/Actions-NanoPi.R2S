...
echo "下载 config"
rm -rf .config
wget https://raw.githubusercontent.com/qqhpc/configfiles/main/openwrt/22.03/x86/64/openwrt-22.03-x86-bypass-gateway.config.txt
mv openwrt-22.03-x86-bypass-gateway.config.txt .config
